...
import { rotateTxt } from "../components/Animations";
      ...
      <div className="first-column">
        <div className="catchword-section">
          ...
          <div className="rotate-bucket">
            <h2 ref={ref => (rot1 = ref)} className="rotate-text">{t("Contact.RotateText")}
              <span style={{ color: "#fdb813" }}>?</span>
            </h2>
            <h2 ref={ref => (rot2 = ref)} className="rotate-text">{t("Contact.RotateText2")}
              <span style={{ color: "#fdb813" }}>?</span>
            </h2>
            <h2 ref={ref => (rot3 = ref)} className="rotate-text">{t("Contact.RotateText3")}
              <span style={{ color: "#fdb813" }}>?</span>
            </h2>
            <h2 ref={ref => (rot4 = ref)} className="rotate-text">{t("Contact.RotateText4")}
              <span style={{ color: "#fdb813" }}>.</span>
            </h2>
          </div>
